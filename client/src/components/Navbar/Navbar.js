...
const Navbar = ({ logout }) => {
	return (
		<nav className='flex justify-between items-center h-16 pl-4 pr-4 md:pl-8 md:pr-8 md:h-20'>
			...
			<button onClick={logout} className='hover:bg-black-tertiary h-8 w-24 border-white border-2 rounded-full text-xs md:text-base'>LOGOUT</button>
		</nav>
	);
}
